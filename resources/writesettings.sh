...
if [ "$ARCH" = "arm" ]; then
  echo "export CROSSCOMPILE=$CDF/resources/crosscompiler/arm/bin/arm-eabi-" >> $FILE # arm CrossCompile
  # Check
...
read -p "   Device Variant: " VARIANT; echo "export VARIANT1=$VARIANT1" >> $FILE
...
unset P; unset MKDTB; unset CLRS
